...
class DeepSeekAnthropicMessagesConfig(AnthropicMessagesConfig):
    ...
    def transform_anthropic_messages_request(
        ...
        should_disable_thinking: Final = self._tool_thinking == "disabled" and (
            bool(request_params_with_thinking_default.get("tools"))
            or deepseek_messages_have_tool_history(normalized_messages)
        )
