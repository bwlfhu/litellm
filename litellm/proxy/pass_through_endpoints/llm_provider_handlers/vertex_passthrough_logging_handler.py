        ...
        **kwargs,
        ...
        try:
            ...
            if httpx_response.status_code == 200 and "name" in _json_response:
                ...
                # Create POSTs to .../batchPredictionJobs; a poll or retrieve targets
                # .../batchPredictionJobs/{id}. Registering on a poll would stamp the row with
                ...
                if url_route.split("?")[0].rstrip("/").endswith("batchPredictionJobs"):
