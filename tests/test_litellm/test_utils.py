    ...
    INTENDED_SCHEMA = {
        ...
        "additionalProperties": {
            ...
            "properties": {
                ...
                "input_cost_per_token_thinking": {"type": "number"},
                "output_cost_per_token_thinking": {"type": "number"},
                "cache_read_input_token_cost_thinking": {"type": "number"},
...
def test_deepseek_v4_models_in_cost_map():
    ...
    for key, expected_input, expected_output, expected_cache in [
        ...
        assert info["max_tokens"] == 393_216
